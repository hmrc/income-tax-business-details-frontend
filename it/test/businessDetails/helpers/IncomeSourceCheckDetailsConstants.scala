...
import common.models.incomeSourceDetails.viewModels.{CheckBusinessDetailsViewModel, CheckDetailsViewModel, CheckPropertyViewModel}
import common.models.incomeSourceDetails.{AddIncomeSourceData, Address, Country}
...
object IncomeSourceCheckDetailsConstants {
  ...
  val testBusinessAddress: Address = Address(lines = Seq(testBusinessAddressLine1), postcode = Some(testBusinessPostCode) , country = Some(Country(Some("GB"), Some("United Kingdom"))))
