...
import common.models.incomeSourceDetails.{LatencyDetails, ManageIncomeSourceData}
          ...
          "is authenticated, with a valid enrolment" should {
            "render the Confirm Reporting Method page" when {
              "all query parameters are valid" in {
                ...
                BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, singleBusinessResponseInLatencyPeriod(latencyDetails))

                BusinessDetailsStub.stubUpdateIncomeSource(OK, Json.toJson(UpdateIncomeSourceResponseModel(timestamp)))
        ...
        s"a user is a $mtdUserRole" that {
          "is authenticated, with a valid enrolment" should {
            "render the Confirm Reporting Method page" when {
              "all query parameters are valid" in {
                stubAuthorised(mtdUserRole)
                BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, singleUKPropertyResponseInLatencyPeriod(latencyDetails))
          ...
          "is authenticated, with a valid enrolment" should {
            "render the Confirm Reporting Method page" when {
              "all query parameters are valid" in {
                ...
                BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, singleForeignPropertyResponseInLatencyPeriod(latencyDetails))
          ...
          "is authenticated, with a valid enrolment" should {
            s"redirect to business will report (completion) page" when {
              "called with a valid form" in {
                ...
                BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, businessOnlyResponse)
          ...
          "is authenticated, with a valid enrolment" should {
            s"redirect to business will report (completion) page" when {
              "called with a valid form" in {
                ...
                BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, ukPropertyOnlyResponse)
        ...
        s"a user is a $mtdUserRole" that {
          "is authenticated, with a valid enrolment" should {
            s"redirect to business will report (completion) page" when {
              "called with a valid form" in {
                stubAuthorised(mtdUserRole)
                BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, foreignPropertyOnlyResponse)
