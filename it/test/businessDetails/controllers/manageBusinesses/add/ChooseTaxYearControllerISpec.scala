...
import common.models.incomeSourceDetails.{AddIncomeSourceData, IncomeSourceReportingFrequencySourceData, LatencyDetails}
        ...
        s"a user is a $mtdUserRole" that {
          ...
          "is authenticated" when {
            ...
            "using the manage businesses journey" in {
              ...
              BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, singleUKForeignPropertyResponseInLatencyPeriod(latencyDetailsCty))
