...
class AddPropertyControllerISpec extends ControllerISpecHelper {
  ...
  val startDateUkPropertyUrl = routes.AddIncomeSourceStartDateController.show(isAgent = true, incomeSourceType = UkProperty, mode = NormalMode).url
  val startDateUkPropertyTrigMigUrl = routes.AddIncomeSourceStartDateController.show(isAgent = true, incomeSourceType = UkProperty, mode = NormalMode, isTriggeredMigration = true).url
  val startDateForeignPropertyUrl = routes.AddIncomeSourceStartDateController.show(isAgent = true, incomeSourceType = ForeignProperty, mode = NormalMode).url
  val startDateForeignPropertyTrigMigUrl = routes.AddIncomeSourceStartDateController.show(isAgent = true, incomeSourceType = ForeignProperty, mode = NormalMode, isTriggeredMigration = true).url
