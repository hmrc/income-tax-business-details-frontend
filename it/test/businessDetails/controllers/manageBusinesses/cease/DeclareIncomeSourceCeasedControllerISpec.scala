...
import common.models.incomeSourceDetails.CeaseIncomeSourceData.ceaseIncomeSourceDeclare
        ...
        s"a user is a $mtdUserRole" that {
          "is authenticated, with a valid enrolment" should {
            "render the income source ceased Page" in {
              ...
              BusinessDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, multipleBusinessesAndPropertyResponse)
          ...
          "is authenticated, with a valid enrolment" should {
            "redirect to IncomeSourceEndDateControllerUrl" when {
              "continue is pressed correctly" in {
                ...
                val expectedRedirectUrl = routes.IncomeSourceEndDateController.show(
                  optIdHash, incomeSourceType, mtdUserRole != MTDIndividual, NormalMode).url
