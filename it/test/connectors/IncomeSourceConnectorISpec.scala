...
class IncomeSourceConnectorISpec extends AnyWordSpec with ComponentSpecBase {

  lazy val connector: IncomeSourceConnector = app.injector.instanceOf[IncomeSourceConnector]

  "IncomeSourceConnector" when {
