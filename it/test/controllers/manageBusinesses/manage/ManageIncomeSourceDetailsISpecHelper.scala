...
class ManageIncomeSourceDetailsISpecHelper extends ControllerISpecHelper {
  ...
  val manageSelfEmploymentShowUrl: String = routes.ManageIncomeSourceDetailsController.show(isAgent = false, SelfEmployment, Some(testSelfEmploymentId)).url
  val manageUKPropertyShowUrl: String = routes.ManageIncomeSourceDetailsController.show(isAgent = false, UkProperty, None).url
  val manageForeignPropertyShowUrl: String = routes.ManageIncomeSourceDetailsController.show(isAgent = false, ForeignProperty, None).url
