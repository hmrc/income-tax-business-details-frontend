...
import testConstants.ITSAStatusUpdateConnectorConstants.*
    ...
    ".getITSAStatusDetail()" when {
      ...
      "happy path" should {
        ...
        "return a successful response" in {
          ...
          val history = true
          val url = s"/income-tax-business-details/itsa-status/status/$taxableEntityId/$year?futureYears=${futureYears.toString}&history=${history.toString}"
