...
import common.helpers.serviceMocks.MTDAgentAuthStub.bakeSessionCookie
...
trait WiremockHelper {
  ...
  def buildClient(path: String) = ws.url(s"http://localhost:$port/manage-self-assessment/businesses$path")
