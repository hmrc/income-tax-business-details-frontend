...
import testConstants.IncomeSourceDetailsTestConstants.{businessIncome2018and2019AndProp, businessInternational}
      ...
      s"the user is authenticated as a $mtdRole" should {
        ...
        "display the ChooseSoleTraderAddress page when OverseasBusinessAddress FS is enabled" when {
          ...
          "user has active UK business addresses" in {
            ...
            val backUrl = frontendAppConfig.homePageUrl(isAgent)
        ...
        "redirect to the homepage" when {
          ...
          "OverseasBusinessAddress FS is disabled" in {
            ...
            val redirectUrl = frontendAppConfig.homePageUrl(isAgent)
