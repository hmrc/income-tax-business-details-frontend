...
import common.models.incomeSourceDetails.viewModels.CeaseIncomeSourcesViewModel
...
import testConstants.IncomeSourceDetailsTestConstants.{businessesAndPropertyIncome, notCompletedUIJourneySessionData}
