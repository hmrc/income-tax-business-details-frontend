...
object IncomeSourceAddedObligationsConstants {
  ...
  val nextUpdatesUrl: String = "/manage-self-assessment/businesses/submission-deadlines"
  val nextUpdatesAgentUrl: String = "/manage-self-assessment/businesses/agents/submission-deadlines"

  def reportingFrequencyPageUrl(isAgent: Boolean): String = if (isAgent) "/manage-self-assessment/businesses/agents/reporting-frequency" else "/manage-self-assessment/businesses/reporting-frequency"
