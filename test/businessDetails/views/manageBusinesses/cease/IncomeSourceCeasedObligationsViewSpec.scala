...
import common.models.incomeSourceDetails.viewModels.{DatesModel, IncomeSourceCeasedObligationsViewModel, ObligationsViewModel}
...
class IncomeSourceCeasedObligationsViewSpec extends ViewSpec {
  ...
  val viewAllBusinessLink = "/manage-self-assessment/businesses/manage-your-businesses"
  val viewUpcomingUpdatesLink = "/manage-self-assessment/businesses/submission-deadlines"
  val viewReportingObligationsLink = "/manage-self-assessment/businesses/reporting-frequency"
  ...
  val viewUpcomingUpdatesURL: String = "/manage-self-assessment/businesses/submission-deadlines"
  ...
  "Income Source Ceased Obligations " should {
    ...
    "show conditional paragraph with obligations link if all businesses are ceased" in new Setup(
