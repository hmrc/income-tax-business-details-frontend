...
class IncomeSourceAddedObligationsViewSpec extends ViewSpec {
  ...
  val getReportingFrequencyUrl = "/manage-self-assessment/businesses/reporting-frequency"
  val getNextUpdatesUrl = "/manage-self-assessment/businesses/submission-deadlines"
          ...
          "display the correct content and the warning inset" in {
            ...
            val viewHelper =
              view(
                ...
                reportingMethod = ChosenReportingMethod.Quarterly,
                getSoftwareUrl = appConfig.compatibleSoftwareLink,
                getReportingFrequencyUrl = "/manage-self-assessment/businesses/reporting-frequency",
                getNextUpdatesUrl = "/manage-self-assessment/businesses/submission-deadlines",
