...
import common.models.incomeSourceDetails.viewModels.{AddIncomeSourcesViewModel, BusinessDetailsViewModel, CeasedBusinessDetailsViewModel, PropertyDetailsViewModel}
...
class AddIncomeSourcesViewSpec extends TestSupport {
  ...
  val backUrl: String = businessDetails.controllers.manageBusinesses.routes.ManageYourBusinessesController.show().url
  val backUrlAgent: String = businessDetails.controllers.manageBusinesses.routes.ManageYourBusinessesController.showAgent().url
