...
import auth.actions.AuthActionsTestData.defaultMTDITUser
...
import testConstants.IncomeSourceDetailsTestConstants.ukPlusForeignPropertyWithSoleTraderIncomeSource
