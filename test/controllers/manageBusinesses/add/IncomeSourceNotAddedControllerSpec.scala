...
import testConstants.IncomeSourceDetailsTestConstants.{businessIncome, foreignPropertyIncome, ukPropertyIncome}

import scala.concurrent.Future
import controllers.manageBusinesses.add.routes as addBusinessRoutes
...
class IncomeSourceNotAddedControllerSpec extends MockAuthActions {
  ...
  lazy val errorUrlSE: String = addBusinessRoutes.IncomeSourceNotAddedController.show(incomeSourceType = SelfEmployment).url
  lazy val agentErrorUrlSE: String = addBusinessRoutes.IncomeSourceNotAddedController.showAgent(incomeSourceType = SelfEmployment).url
  lazy val errorUrlUK: String = addBusinessRoutes.IncomeSourceNotAddedController.show(incomeSourceType = UkProperty).url
  lazy val agentErrorUrlUK: String = addBusinessRoutes.IncomeSourceNotAddedController.showAgent(incomeSourceType = UkProperty).url
  lazy val errorUrlFP: String = addBusinessRoutes.IncomeSourceNotAddedController.show(incomeSourceType = ForeignProperty).url
  lazy val agentErrorUrlFP: String = addBusinessRoutes.IncomeSourceNotAddedController.showAgent(incomeSourceType = ForeignProperty).url
