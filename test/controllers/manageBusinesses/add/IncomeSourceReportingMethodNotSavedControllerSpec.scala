...
import testConstants.IncomeSourceDetailsTestConstants.ukPlusForeignPropertyAndSoleTraderNoLatency
...
class IncomeSourceReportingMethodNotSavedControllerSpec extends MockAuthActions with MockSessionService {
  ...
  object TestConstants {
    ...
    val selfEmploymentAddedUrl: String = addBusinessRoutes.IncomeSourceAddedController.show(SelfEmployment).url
    val ukPropertyAddedUrl: String = addBusinessRoutes.IncomeSourceAddedController.show(UkProperty).url
    val foreignPropertyAddedUrl: String = addBusinessRoutes.IncomeSourceAddedController.show(ForeignProperty).url

    val selfEmploymentAddedAgentUrl: String = addBusinessRoutes.IncomeSourceAddedController.showAgent(SelfEmployment).url
    val ukPropertyAddedAgentUrl: String = addBusinessRoutes.IncomeSourceAddedController.showAgent(UkProperty).url
    val foreignPropertyAddedAgentUrl: String = addBusinessRoutes.IncomeSourceAddedController.showAgent(ForeignProperty).url
  }
