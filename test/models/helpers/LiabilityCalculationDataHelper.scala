...
trait LiabilityCalculationDataHelper {
  ...
  val errorMessagesIndividual = Some(List(
    ...
    Message("C55007", "Period submission does not align to cessation date of 2024-04-05. Please amend and resubmit.")
  ))
