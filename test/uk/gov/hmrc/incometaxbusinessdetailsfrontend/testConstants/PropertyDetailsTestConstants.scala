...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.{AccountingPeriodModel, CessationModel}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.viewmodels.{CeasePropertyDetailsViewModel, PropertyDetailsViewModel, ViewPropertyDetailsViewModel}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.{LatencyDetails, PropertyDetailsModel}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.obligations.models.{SingleObligationModel, StatusFulfilled}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.obligations.testConstants.NextUpdatesTestConstants.fakeNextUpdatesModel
