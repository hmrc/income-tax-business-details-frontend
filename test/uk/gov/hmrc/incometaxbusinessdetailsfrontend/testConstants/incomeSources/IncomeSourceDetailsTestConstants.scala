...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.testConstants.incomeSources

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.IncomeSourceJourney.{ForeignProperty, IncomeSourceType, SelfEmployment, UkProperty}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.JourneyType.{Add, IncomeSourceJourneyType}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TriggeredMigration.Channel.HmrcUnconfirmed
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.UIJourneySessionData
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.{AddressModel, IncomeSourceId}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails._
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.viewmodels.{CeaseIncomeSourcesViewModel, CheckCeaseIncomeSourceDetailsViewModel}
