...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.*
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.{BusinessDetailsModel, LatencyDetails, QuarterTypeElection}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.obligations.models.{GroupedObligationsModel, ObligationsModel, SingleObligationModel, StatusFulfilled}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.obligations.testConstants.NextUpdatesTestConstants.{fakeNextUpdatesModel, openObligation, overdueObligation}
