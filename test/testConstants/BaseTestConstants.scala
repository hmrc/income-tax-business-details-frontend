...
object BaseTestConstants extends UnitSpec with GuiceOneAppPerSuite {
  ...
  val testPaymentRedirectUrl = "http://localhost:9088/manage-self-assessment/businesses"
  ...
  val testNavHtml: Html = HtmlFormat.raw(
    "<html><head></head><body>  <nav id='secondary-nav' class='hmrc-account-menu'> " +
      ...
      "<li> <a href='http://localhost:9088/manage-self-assessment/businesses' id='nav-bar-link-testEnHome' class='hmrc-account-menu__link'> testEnHome </a> </li>" +
