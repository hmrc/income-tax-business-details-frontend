...
import common.enums.ChargeType.NIC4_WALES
import common.enums.CodingOutType._
import common.models.creditDetailModel.CreditDetailModel
import common.models.creditsandrefunds.{CreditsModel, Transaction}
import common.models.financialDetails._
import common.models.incomeSourceDetails.TaxYear
import common.models.outstandingCharges.{OutstandingChargeModel, OutstandingChargesModel}
...
object FinancialDetailsTestConstants {
  ...
  def financialDetailsModelWithPoaOneAndTwoWithRarAndAmendmentCredits() =
    FinancialDetailsModel(
      balanceDetails = balanceDetails,
      documentDetails = List(
        ...
        documentDetailModel(transactionId = id1040000127, taxYear = testTaxYear, paymentLot = None, paymentLotItem = None, accruingInterestAmount = None, documentDueDate = Some(LocalDate.of(2020,1,1)), interestOutstandingAmount = None, originalAmount = -100)
      ),
      financialDetails = List(
        ...
        financialDetail(transactionId = Some(id1040000127), taxYear = testTaxYear, mainTransaction = "4916")
      )
    )
  ...
  def financialDetailsModelWithPoaOneAndTwoWithCrystallisedInterest() =
    FinancialDetailsModel(
      balanceDetails = balanceDetails,
      documentDetails = List(
        documentDetailModel(transactionId = id1040000126, taxYear = testTaxYear, outstandingAmount = 0.00, originalAmount = 1500.00, paymentLot = None, paymentLotItem = None, accruingInterestAmount = None, interestOutstandingAmount = Some(100), documentDueDate = Some(LocalDate.of(2020,1,1))),
        documentDetailModel(transactionId = id1040000125, taxYear = testTaxYear, outstandingAmount = 0.00, originalAmount = 1500.00, paymentLot = None, paymentLotItem = None, accruingInterestAmount = None, interestOutstandingAmount = Some(100), documentDueDate = Some(LocalDate.of(2020,1,1)))
      ),
      financialDetails = List(
        financialDetail(transactionId = Some(id1040000125), taxYear = testTaxYear, mainTransaction = "4920"),
        financialDetail(transactionId = Some(id1040000126), taxYear = testTaxYear, mainTransaction = "4930")
  ...
  private def testFinancialDetailsModel(dueDate: List[Option[LocalDate]],
                                        ...
                                        balanceDetails: BalanceDetails = BalanceDetails(1.00, 2.00, 4.00, 3.00, None, None, None, None, None, None, None)): FinancialDetailsModel =
    FinancialDetailsModel(
      balanceDetails = balanceDetails,
      documentDetails = List(
    ...
    FinancialDetailsModel(
      ...
      documentDetails = List(
        DocumentDetail(taxYear.toInt, id1040000124, documentDescription.head, Some("documentText"), outstandingAmount.head, 43.21, LocalDate.of(2018, 3, 29), Some(100), Some(100), Some("latePaymentInterestId1"),
          None, Some(LocalDate.of(2018, 3, 29)), Some(LocalDate.of(2018, 3, 29)), None, None, Some("paymentLotItem"), Some("paymentLot"), effectiveDateOfPayment = dueDate.head, documentDueDate = dueDate.head),
        DocumentDetail(taxYear.toInt, id1040000125, documentDescription(1), Some("documentText"), outstandingAmount(1), 12.34, LocalDate.of(2018, 3, 29), Some(100), Some(100), Some("latePaymentInterestId2"),
          None, Some(LocalDate.of(2018, 3, 29)), Some(LocalDate.of(2018, 3, 29)), None, None, Some("paymentLotItem"), Some("paymentLot"), effectiveDateOfPayment = dueDate(1), documentDueDate = dueDate(1))
      ),
      financialDetails = List(
  ...
  def testFinancialDetailsModelWithPayeSACodingOutFullyCollected(): FinancialDetailsModel =
    FinancialDetailsModel(
      balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, None, None, None, None, None, None, None),
      documentDetails = List(
        DocumentDetail(taxYear = 2021, transactionId = "CODINGOUT01", documentDescription = Some("TRM New Charge"),
      ...
      financialDetails = List(
        FinancialDetail("2021", Some("SA Balancing Charge"), Some("4910"), Some("CODINGOUT01"), Some(LocalDate.parse("2022-08-16")), Some("ABCD1234"), Some("type"), Some(100), Some(100),
          Some(100), Some(100), Some(NIC4_WALES), Some(100), Some(Seq(SubItem(dueDate = Some(LocalDate.parse("2021-08-25")), codedOutStatus = Some("F")))))
      )
    )

  def testFinancialDetailsModelWithPayeSACodingOutPOA1FullyCollected(): FinancialDetailsModel =
    FinancialDetailsModel(
      balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, None, None, None, None, None, None, None),
      documentDetails = List(
        DocumentDetail(taxYear = 2021, transactionId = "CODINGOUT01", documentDescription = Some("TRM New Charge"),
  ...
  def testFinancialDetailsModelWithPayeSACodingOutPOA2FullyCollected(): FinancialDetailsModel =
    FinancialDetailsModel(
      balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, None, None, None, None, None, None, None),
      documentDetails = List(
        DocumentDetail(taxYear = 2021, transactionId = "CODINGOUT01", documentDescription = Some("TRM New Charge"),
  ...
  def testFinancialDetailsModelWithAccruingInterest(documentDescription: List[Option[String]],
    ...
    FinancialDetailsModel(
      balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, None, None, None, None, None, None, None),
      documentDetails = List(
        DocumentDetail(taxYear.toInt, id1040000124, documentDescription.head, Some("documentText"), outstandingAmount.head, 43.21, LocalDate.of(2018, 3, 29), None, interestRate.head, Some("latePaymentInterestId1"), None, Some(LocalDate.parse("2019-05-25")), Some(LocalDate.parse("2019-06-25")), accruingInterestAmount.head, effectiveDateOfPayment = dueDate.head, documentDueDate = dueDate.head),
        DocumentDetail(taxYear.toInt, id1040000125, documentDescription(1), Some("documentText"), outstandingAmount(1), 12.34, LocalDate.of(2018, 3, 29), None, interestRate(1), Some("latePaymentInterestId2"), None,  Some(LocalDate.parse("2019-05-25")), Some(LocalDate.parse("2019-06-25")), accruingInterestAmount(1), effectiveDateOfPayment = dueDate(1), documentDueDate = dueDate(1))
      ),
      financialDetails = List(
        FinancialDetail(taxYear, mainType.head, mainTransaction.head, Some(id1040000124), Some(LocalDate.parse("2022-08-16")), Some("ABCD1234"), Some("type"), Some(100), Some(100), Some(100), Some(100), Some(NIC4_WALES), Some(100), Some(Seq(SubItem(dueDate.head, dunningLock = dunningLock.head)))),
        FinancialDetail(taxYear, mainType(1), mainTransaction(1), Some(id1040000125), Some(LocalDate.parse("2022-08-16")), Some("ABCD1234"), Some("type"), Some(100), Some(100), Some(100), Some(100), Some(NIC4_WALES), Some(100), Some(Seq(SubItem(dueDate(1), dunningLock = dunningLock(1)))))
    ...
    FinancialDetailsModel(
      ...
      documentDetails = List(
        ...
        DocumentDetail(fixedDateTwo.getYear, id1040000126, Some("ITSA- POA 2"), Some("documentText"), 50, 43.21, LocalDate.of(2018, 3, 29), Some(100), Some(100), Some("latePaymentInterestId"), None,
          Some(LocalDate.of(2018, 3, 29)), Some(LocalDate.of(2018, 3, 29)), Some(100), Some(100), Some("paymentLotItem"), Some("paymentLot"), effectiveDateOfPayment = Some(fixedDateTwo.minusDays(1)), documentDueDate = Some(fixedDateTwo.plusDays(30))),
        DocumentDetail(fixedDateTwo.getYear, id1040000123, Some("SA POA 1 Reconciliation Debit"), Some("documentText"), 50, 43.21, LocalDate.of(2018, 3, 29), Some(100), Some(100), Some("latePaymentInterestId"), None,
          Some(LocalDate.of(2018, 3, 29)), Some(LocalDate.of(2018, 3, 29)), Some(100), Some(100), Some("paymentLotItem"), Some("paymentLot"), effectiveDateOfPayment = Some(fixedDateTwo.minusDays(1)), documentDueDate = Some(fixedDateTwo.plusDays(30))),
...
case class ANewCreditAndRefundModel(model: CreditsModel = CreditsModel(0.0, 0.0, 0.0, 0.0, None, None, Nil)) {
  ...
  def withCutoverCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(CutOverCreditType, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), None, "cutover")))
  }

  def withFirstRefund(amount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(Repayment, amount, taxYear = None, None, None, "refund1")))
  }

  def withSecondRefund(amount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(Repayment, amount, taxYear = None, None, None, "refund2")))
  }

  def withBalancingChargeCredit(dueDate: LocalDate, outstandingAmount: BigDecimal, id: String = "balancing") = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(BalancingChargeCreditType, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), None, id)))
  }

  def withRepaymentInterest(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(RepaymentInterest, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), None, "repayment")))
  }

  def withMfaCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(MfaCreditType, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), None, "mfa")))
  }

  def withPayment(dueDate: LocalDate, outstandingAmount: BigDecimal, effectiveDateOfPayment: Option[LocalDate] = None) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(PaymentType, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), Some(effectiveDateOfPayment.getOrElse(dueDate)), "payment")))
  }

  def withPoaOneReconciliationCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(PoaOneReconciliationCredit, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), None,"POA1RR-credit")))
  }

  def withPoaTwoReconciliationCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+
      Transaction(PoaTwoReconciliationCredit, outstandingAmount, taxYear = Some(TaxYear.getTaxYear(dueDate)), dueDate = Some(dueDate), None, "POA2RR-credit")))
  }
