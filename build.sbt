...
lazy val scoverageSettings = {
  ...
  Seq(
    ScoverageKeys.coverageExcludedPackages := "<empty>;controllers\\..*Reverse.*;models/.data/..*;" +
      "filters.*;.handlers.*;components.*;.*BuildInfo.*;.*standardError*.*;.*Routes.*;views.html.*;FrontendAppConfig.*;" +
      "controllers.feedback.*;app.*;prod.*;FrontendAppConfig.*;com.*;testOnlyDoNotUseInAppConf.*;testOnly.*;\"",
...
lazy val microservice = Project(appName, file("."))
  ...
  .settings(
    ...
    RoutesKeys.routesImport := Seq("uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.IncomeSourceJourney._", "uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.admin._", "uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core._")
  )
