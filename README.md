...
```
sm2 --start ITVC_BUSINESS_DETAILS_TEST --appendArgs '{"CITIZEN_DETAILS":["-Dmongodb.cid-sautr-cache.enabled=false"]}'
```
...
```
sbt "run 9088 -Dplay.http.router=testOnlyDoNotUseInAppConf.Routes"
```
or
```
./run.sh
