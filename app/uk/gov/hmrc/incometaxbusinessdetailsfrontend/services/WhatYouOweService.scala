...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.services

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.AuditingService
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models.WhatYouOweResponseAuditModel
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors.{FinancialDetailsConnector, OutstandingChargesConnector}
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.ChargeItem.isAKnownTypeOfCharge
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.nextPayments.viewmodels.WYOClaimToAdjustViewModel
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.outstandingCharges.{OutstandingChargesErrorModel, OutstandingChargesModel}
...
class WhatYouOweService @Inject()(val financialDetailsService: FinancialDetailsService,
  ...
  def claimToAdjustViewModel(nino: Nino)(implicit hc: HeaderCarrier, user: MtdItUser[_]): Future[WYOClaimToAdjustViewModel] = {
