...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.claimToAdjustPoa

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.MtdItUser
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors.{CalculationListConnector, ChargeHistoryConnector}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.{Poa1Charge, Poa2Charge}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.calculationList.{CalculationListErrorModel, CalculationListModel}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.chargeHistory.{ChargeHistoryModel, ChargesHistoryErrorModel, ChargesHistoryModel}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.claimToAdjustPoa.viewModels.PaymentOnAccountViewModel
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.TaxYear.makeTaxYearWithEndYear
import play.api.Logger
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.DateServiceInterface
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.claimToAdjustPoa.ClaimToAdjustHelper.{isPoaOne, isPoaTwo}
