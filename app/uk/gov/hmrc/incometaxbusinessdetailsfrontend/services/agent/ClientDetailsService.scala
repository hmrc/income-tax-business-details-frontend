...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.agent

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors.BusinessDetailsConnector
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors.agent.CitizenDetailsConnector
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.citizenDetails.{CitizenDetailsErrorModel, CitizenDetailsModel}
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.agent.ClientDetailsService.{BusinessDetailsNotFound, CitizenDetailsNotFound, ClientDetails, ClientDetailsFailure}
