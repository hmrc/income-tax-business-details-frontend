...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.JourneyType.*
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.UIJourneySessionData
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.{AddIncomeSourceData, CeaseIncomeSourceData, ManageIncomeSourceData}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.repositories.{SensitiveUIJourneySessionDataRepository, UIJourneySessionDataRepository}
