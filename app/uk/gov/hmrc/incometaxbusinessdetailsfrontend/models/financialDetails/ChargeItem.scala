...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.exceptions.{CouldNotCreateChargeItemException, MissingFieldException}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.ChargeType.{poaOneReconciliationDebit, poaTwoReconciliationDebit}
...
case class ChargeItem(
  ...
  def isIncludedInSACSummary: Boolean = {
    ...
    val validCharge = (transactionType, codedOutStatus) match {
      ...
      case (BalancingCharge, Some(FullyCollected)) => true
