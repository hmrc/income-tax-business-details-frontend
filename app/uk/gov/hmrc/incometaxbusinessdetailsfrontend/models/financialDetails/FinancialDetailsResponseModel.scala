...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.chargeSummary.{PaymentHistoryAllocation, PaymentHistoryAllocations}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.ChargeType.allChargeMainTransactions
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.CreditType.{creditsWithSummaryPages, cutOver}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.ReviewAndReconcileUtils.{isReviewAndReconcilePoaOne, isReviewAndReconcilePoaTwo}
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.claimToAdjustPoa.ClaimToAdjustHelper.poaDocumentDescriptions
      ...
      .map { subItems =>
        subItems.collect {
            case subItem if subItem.clearingSAPDocument.isDefined =>
              ...
              val (taxYear, isCredit, isCutoverCredit) = finDetailOfSource match {
              ...
              PaymentHistoryAllocation(
                ...
                taxYear = taxYear,
                isCredit = isCredit,
                isCutoverCredit = isCutoverCredit
              )
          }
