...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.FinancialDetail.Types.*
...
case class FinancialDetail(taxYear: String,
  ...
  def getChargeType: Option[TransactionType] = mainTransaction.flatMap(TransactionType.fromCode)
}
