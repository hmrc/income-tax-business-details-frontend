...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.chargeHistory

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.{AdjustmentReversalReason, AmendedReturnReversalReason, CustomerRequestReason, ReversalReason}
import play.api.libs.json.{Format, Json}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.claimToAdjustPoa.ClaimToAdjustHelper.isPoaDocumentDescription
