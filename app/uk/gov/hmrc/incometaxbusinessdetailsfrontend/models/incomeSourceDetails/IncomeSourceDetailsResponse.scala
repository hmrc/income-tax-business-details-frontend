...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TriggeredMigration.Channel.{CustomerLed, HmrcConfirmed}
