...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.ResponseModel.{ResponseModel, UnexpectedError}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.{CorrelationId, Nino}
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.{TaxYear, TaxYearRange}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.paymentAllocationCharges.{FinancialDetailsWithDocumentDetailsErrorModel, FinancialDetailsWithDocumentDetailsModel, FinancialDetailsWithDocumentDetailsResponse}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.paymentAllocations.{PaymentAllocations, PaymentAllocationsError, PaymentAllocationsResponse}
import play.api.Logger
import play.api.http.Status
import play.api.http.Status.{INTERNAL_SERVER_ERROR, OK}
import uk.gov.hmrc.http.client.HttpClientV2
import uk.gov.hmrc.http.{HeaderCarrier, HttpResponse, StringContextOps}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.utils.Headers.checkAndAddTestHeader
