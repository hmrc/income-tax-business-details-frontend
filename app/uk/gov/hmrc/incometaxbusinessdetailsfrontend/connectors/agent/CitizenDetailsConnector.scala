...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors.agent
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.citizenDetails.{CitizenDetailsErrorModel, CitizenDetailsModel, CitizenDetailsResponseModel}
