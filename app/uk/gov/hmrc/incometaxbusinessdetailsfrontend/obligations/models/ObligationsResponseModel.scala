...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.obligations.models

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.MtdItUser
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.QuarterTypeElection.orderingByTypeName
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.{PropertyDetailsModel, QuarterReportingType, QuarterTypeCalendar, QuarterTypeStandard}
