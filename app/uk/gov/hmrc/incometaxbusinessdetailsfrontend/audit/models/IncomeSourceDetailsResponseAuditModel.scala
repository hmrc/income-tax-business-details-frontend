...
case class IncomeSourceDetailsResponseAuditModel(
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.IncomeSourceDetailsResponse
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.IncomeSourceDetailsResponse
