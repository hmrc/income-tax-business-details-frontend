...
case class ConfirmClientDetailsAuditModel(clientName: String,
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.ClientDetailsConfirmed

  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.ClientDetailsConfirmed
