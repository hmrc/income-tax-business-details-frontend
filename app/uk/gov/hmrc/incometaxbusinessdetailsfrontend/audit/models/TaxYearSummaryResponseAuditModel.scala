...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.implicits.ImplicitDateParser
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.liabilitycalculation.Messages
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.liabilitycalculation.viewmodels.TaxYearSummaryViewModel
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.taxyearsummary.TaxYearSummaryChargeItem
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.obligations.models.ObligationWithIncomeType
...
case class TaxYearSummaryResponseAuditModel(mtdItUser: MtdItUser[_],
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.TaxYearOverviewResponse
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.TaxYearOverviewResponse
