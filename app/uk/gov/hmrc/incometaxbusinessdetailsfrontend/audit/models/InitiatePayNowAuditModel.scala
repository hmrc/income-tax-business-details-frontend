...
case class InitiatePayNowAuditModel(mtditid: String, nino: String,
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.InitiatePayNow
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.InitiatePayNow
