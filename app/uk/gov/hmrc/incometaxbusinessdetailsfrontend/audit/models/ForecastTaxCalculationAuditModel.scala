...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.liabilitycalculation.EndOfYearEstimate
...
case class ForecastTaxCalculationAuditModel(user: MtdItUser[_], endOfYearEstimate: EndOfYearEstimate)
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.ForecastTaxCalculation
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.ForecastTaxCalculation
