...
case class PaymentHistoryResponseAuditModel(mtdItUser: MtdItUser[_],
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.PaymentHistoryResponse
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.PaymentHistoryResponse
