...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.CreditType
...
object CreditSummaryAuditing {
  ...
  case class CreditsSummaryModel(saUTR: String,
    ...
    override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.CreditsSummary
    override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.CreditsSummaryResponse
