...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.AccountingPeriodModel
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.paymentAllocationCharges.{AllocationDetailWithClearingDate, PaymentAllocationViewModel}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.paymentAllocations.AllocationDetail
...
case class PaymentAllocationsResponseAuditModel(mtdItUser: MtdItUser[_],
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.PaymentAllocations
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.PaymentAllocations
