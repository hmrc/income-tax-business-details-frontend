...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.ChargeSummary
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.chargeHistory.ChargeHistoryModel
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.utils.JsonUtils
...
case class ChargeSummaryAudit(mtdItUser: MtdItUser[_],
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.ChargeSummary
