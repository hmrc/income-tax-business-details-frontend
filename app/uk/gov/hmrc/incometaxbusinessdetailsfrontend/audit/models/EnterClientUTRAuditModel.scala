...
case class EnterClientUTRAuditModel(isSuccessful: Boolean,
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.EnterClientUTR

  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.EnterClientUTR
