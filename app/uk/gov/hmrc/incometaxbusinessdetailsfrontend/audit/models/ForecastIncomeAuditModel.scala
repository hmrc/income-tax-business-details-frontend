...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.liabilitycalculation.{EndOfYearEstimate, IncomeSource}
...
case class ForecastIncomeAuditModel(user: MtdItUser[_], endOfYearEstimate: EndOfYearEstimate)
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.ForecastIncome
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.ForecastIncome
