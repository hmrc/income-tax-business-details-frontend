...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.Utilities._
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.MtdItUser
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.financialDetails.{ChargeItem, CodingOutDetails, WhatYouOweChargesList}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.outstandingCharges.OutstandingChargesModel
...
case class WhatYouOweResponseAuditModel(user: MtdItUser[_],
  ...
  override val transactionName: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.TransactionName.WhatYouOweResponse
  override val auditType: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType.WhatYouOweResponse
