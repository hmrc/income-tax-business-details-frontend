...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.utils

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.MtdItUser
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.businessDetails.controllers.manageBusinesses.add.routes as addBusinessesRoutes
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.businessDetails.controllers.manageBusinesses.cease.routes as ceaseBusinessesRoutes
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.businessDetails.controllers.manageBusinesses.manage.routes as manageBusinessesRoutes
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.businessDetails.controllers.manageBusinesses.routes as manageYourBusinessRoutes
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.JourneyType.{Add, Cease, IncomeSourceJourneyType, Manage}
