...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.{MTDIndividual, MTDSupportingAgent, MTDUserRole}
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.authV2.models.{AgentClientDetails, AuthUserDetails}
