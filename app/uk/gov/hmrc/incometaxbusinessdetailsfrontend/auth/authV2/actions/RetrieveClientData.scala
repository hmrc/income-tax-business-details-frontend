...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.authV2.models.{AgentClientDetails, AuthorisedAgentWithClientDetailsRequest, AuthorisedUserRequest}
import com.google.inject.Singleton
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.config.{AgentItvcErrorHandler, FrontendAppConfig}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent.routes
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent.sessionUtils.SessionKeys
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.sessionData.SessionDataGetResponse.SessionDataNotFound
