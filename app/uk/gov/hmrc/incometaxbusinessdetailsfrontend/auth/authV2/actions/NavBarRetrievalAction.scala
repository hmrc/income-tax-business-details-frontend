...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.config.{FrontendAppConfig, ItvcErrorHandler}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.bta.BtaNavBarController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.forms.utils.SessionKeys
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.OriginEnum
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.OriginEnum.{BTA, PTA}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.admin.NavBarFs
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.navbar.{BtaPartial, PtaPartial}
