...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.businessDetails.controllers.manageBusinesses.manage
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.JourneyType.{IncomeSourceJourneyType, Manage}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.admin.{DisplayBusinessStartDate, OptInOptOutContentUpdateR17}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.IncomeSourceId.mkIncomeSourceId
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.IncomeSourceIdHash.{mkFromQueryString, mkIncomeSourceIdHash}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.{IncomeSourceId, IncomeSourceIdHash}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.*
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.viewmodels.ManageIncomeSourceDetailsViewModel
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.itsaStatus.ITSAStatus
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.itsaStatus.ITSAStatus.ITSAStatus
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.manageBusinesses.manage.ManageIncomeSourceDetailsView
...
class ManageIncomeSourceDetailsController @Inject()(view: ManageIncomeSourceDetailsView,
  ...
  with FeatureSwitching with I18nSupport with JourneyCheckerManageBusinesses {
...
//        val backUrl = routes.ManageObligationsController.show(isAgent, incomeSourceType).url
//        incomeSourceType match {
