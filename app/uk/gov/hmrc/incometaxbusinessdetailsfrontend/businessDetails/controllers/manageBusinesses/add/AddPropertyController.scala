...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.IncomeSourceJourney.{ForeignProperty, UkProperty}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.forms.manageBusinesses.add.{AddPropertyForm => form}
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.manageBusinesses.add.AddPropertyView
