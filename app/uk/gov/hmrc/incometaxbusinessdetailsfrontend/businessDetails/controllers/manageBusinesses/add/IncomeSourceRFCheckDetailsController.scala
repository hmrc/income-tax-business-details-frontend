...
//import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models.IncomeSourceReportingMethodAuditModel
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.{AfterSubmissionPage, ReportingFrequencyPages}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.admin.OptInOptOutContentUpdateR17
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.core.{IncomeSourceId, NormalMode}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.IncomeSourceDetailsModel
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.incomeSourceDetails.viewmodels.*
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.updateIncomeSource.{TaxYearSpecific, UpdateIncomeSourceResponse, UpdateIncomeSourceResponseError, UpdateIncomeSourceResponseModel}
import play.api.Logger
import play.api.i18n.I18nSupport
import play.api.mvc.*
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.manageBusinesses.IncomeSourceRFService
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.{CreateBusinessDetailsService, DateServiceInterface, SessionService, UpdateIncomeSourceService}
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.utils.JourneyCheckerManageBusinesses
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.manageBusinesses.add.IncomeSourceRFCheckDetailsView
...
class IncomeSourceRFCheckDetailsController @Inject()(
                                                     val checkDetailsView: IncomeSourceRFCheckDetailsView,
  ...
  with JourneyCheckerManageBusinesses with I18nSupport with FeatureSwitching{
//
...
//  }
  ...
  private def handleRequest(@unused sources: IncomeSourceDetailsModel,
    ...
    withSessionData(IncomeSourceJourneyType(Add, incomeSourceType), AfterSubmissionPage) { sessionData =>
      ...
      val backUrl: String = routes.AddIncomeSourceStartDateController.show(isAgent, NormalMode, incomeSourceType).url
      val postAction: Call = if (isAgent) routes.IncomeSourceRFCheckDetailsController.submit(isAgent, incomeSourceType) else {
        routes.IncomeSourceRFCheckDetailsController.submit(isAgent, incomeSourceType)
      }
      Future.successful {
        Ok(checkDetailsView(
