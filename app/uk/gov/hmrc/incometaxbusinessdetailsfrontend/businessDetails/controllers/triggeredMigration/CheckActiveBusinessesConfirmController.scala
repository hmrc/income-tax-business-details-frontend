...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.businessDetails.models.audit.TriggeredMigrationCompleteAuditModel
import com.google.inject.{Inject, Singleton}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.config.FrontendAppConfig
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.forms.triggeredMigration.CheckActiveBusinessesConfirmForm
import play.api.i18n.I18nSupport
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.CustomerFactsUpdateService
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.triggeredMigration.TriggeredMigrationService
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.utils.TriggeredMigrationUtils
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.triggeredMigration.CheckActiveBusinessesConfirmView
