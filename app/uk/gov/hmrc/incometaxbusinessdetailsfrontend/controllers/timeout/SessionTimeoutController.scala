...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.timeout

import com.google.inject.{Inject, Singleton}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.config.FrontendAppConfig
import play.api.mvc.*
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.timeout.TimeoutView
