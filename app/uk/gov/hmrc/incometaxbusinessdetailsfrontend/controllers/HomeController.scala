...
//import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models.HomeAudit
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.MTDSupportingAgent
...
//import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.homePage.*
...
//import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.outstandingCharges.{OutstandingChargeModel, OutstandingChargesModel}
...
//                                val homeView: views.html.HomeView,
...
//  }
  ...
  private def handleYourTasks(@unused origin: Option[String] = None, isAgent: Boolean)
    ...
    if(isAgent){
      Future.successful(Redirect(uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.newHomePage.routes.HandleYourTasksController.showAgent()))
    }else {
     Future.successful(Redirect(uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.newHomePage.routes.HandleYourTasksController.show()))
    }
  }
