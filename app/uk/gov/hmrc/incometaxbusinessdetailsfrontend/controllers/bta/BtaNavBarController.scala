...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.bta

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.connectors.BtaNavBarPartialConnector
import play.api.Logging
import play.api.i18n.Messages
import play.api.mvc.{MessagesControllerComponents, Request}
import play.api.routing.Router.RequestImplicits.WithHandlerDef
import play.twirl.api.Html
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.BtaNavBarService
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.navbar.BtaNavBar
