...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent

import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.AuditingService
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models.EnterClientUTRAuditModel
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.FrontendAuthorisedFunctions
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.authV2.AuthActions
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.auth.authV2.models.AuthorisedUserRequest
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.config.featureswitch.FeatureSwitching
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.config.{AgentItvcErrorHandler, FrontendAppConfig}
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent.AuthUtils._
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent.sessionUtils.SessionKeys
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums._
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.forms.agent.ClientsUTRForm
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.sessionData.SessionCookieData
import play.api.Logger
import play.api.i18n.I18nSupport
import play.api.mvc._
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.agent.ClientDetailsService
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.agent.ClientDetailsService.{BusinessDetailsNotFound, CitizenDetailsNotFound}
import uk.gov.hmrc.auth.core.Enrolment
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.agent.EnterClientsUTRView
            ...
            case Right(clientDetails) =>
              checkAgentAuthorisedAndGetRole(clientDetails.mtdItId).flatMap { userRole =>
                ...
                case ex =>
                  ...
                  Redirect(uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent.routes.UTRErrorController.show())
              }
