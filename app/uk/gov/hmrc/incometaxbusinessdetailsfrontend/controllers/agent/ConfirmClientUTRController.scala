...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models.ConfirmClientDetailsAuditModel
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.models.sessionData.SessionDataPostResponse.{SessionDataPostFailure, SessionDataPostSuccess}
import play.api.Logger
import play.api.i18n.I18nSupport
import play.api.mvc._
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.SessionDataService
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.agent.ConfirmClientUTRView
  ...
  def submit: Action[AnyContent] =
    authActions.asMTDAgentWithUnconfirmedClient.async { implicit user =>
      ...
      handleSessionCookies(
        ...
        Future(
          Redirect(uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.routes.HomeController.showAgent().url)
            .addingToSession(SessionKeys.confirmedClient -> "true")
        )
    }
    }

  lazy val backUrl: String = uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.agent.routes.EnterClientsUTRController.show().url
