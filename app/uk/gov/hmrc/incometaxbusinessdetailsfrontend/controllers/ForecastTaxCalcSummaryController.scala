...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.audit.models.ForecastTaxCalculationAuditModel
...
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.services.CalculationService
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendController
import uk.gov.hmrc.play.language.LanguageUtils
import uk.gov.hmrc.incometaxbusinessdetailsfrontend.views.html.ForecastTaxCalcSummaryView
...
class ForecastTaxCalcSummaryController @Inject()(val authActions: AuthActions,
  ...
  def backUrl(isAgent: Boolean, taxYear: Int, origin: Option[String]): String =
    if (isAgent) uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.routes.TaxYearSummaryController.renderAgentTaxYearSummaryPage(taxYear).url
    else uk.gov.hmrc.incometaxbusinessdetailsfrontend.controllers.routes.TaxYearSummaryController.renderTaxYearSummaryPage(taxYear, origin).url
}
