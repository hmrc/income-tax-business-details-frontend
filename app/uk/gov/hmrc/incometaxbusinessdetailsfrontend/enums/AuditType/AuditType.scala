...
package uk.gov.hmrc.incometaxbusinessdetailsfrontend.enums.AuditType
...
case object TriggeredMigrationStart extends AuditType {
  val name = "TriggeredMigrationStart"
}
