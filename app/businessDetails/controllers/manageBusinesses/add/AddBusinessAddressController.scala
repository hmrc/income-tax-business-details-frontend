...
import common.models.incomeSourceDetails.{AddIncomeSourceData, BusinessAddressModel}
...
class AddBusinessAddressController @Inject()(val authActions: AuthActions,
  ...
  private def setUpSession(addressLookUpResult: Either[Throwable, BusinessAddressModel], id: Option[String])
