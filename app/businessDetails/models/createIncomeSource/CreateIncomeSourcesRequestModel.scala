...
final case class CreateBusinessIncomeSourceRequest(mtdbsa: String, businessDetails: List[BusinessDetails], idempotencyKey: Option[String] = None, addIncomeSource: Option[Boolean] = None) {
...
final case class CreateForeignPropertyIncomeSourceRequest(mtdbsa: String, foreignPropertyDetails: PropertyDetails, idempotencyKey: Option[String] = None, addIncomeSource: Option[Boolean] = None) {
  require(mtdbsa.matches("^[A-Z]{4}[0-9]{11}$"), "MTDBSA ID should be of 11 characters and a specific format")
}

final case class CreateUKPropertyIncomeSourceRequest(mtdbsa: String, ukPropertyDetails: PropertyDetails, idempotencyKey: Option[String] = None, addIncomeSource: Option[Boolean] = None) {
  require(mtdbsa.matches("^[A-Z]{4}[0-9]{11}$"), "MTDBSA ID should be of 11 characters and a specific format")
}
