...
package common.models.incomeSourceDetails.viewModels
...
case class CheckPropertyViewModel(tradingStartDate: LocalDate, incomeSourceType: IncomeSourceType, idempotencyKey: Option[String] = None) extends CheckDetailsViewModel {
